    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16 opacity-0 animate-fade-in" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature Card 1 */}
            <div className="bg-white rounded-xl p-8 shadow-md transition-all duration-300 hover:shadow-lg opacity-0 animate-fade-in" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            ...
            {/* Feature Card 2 */}
            <div className="bg-white rounded-xl p-8 shadow-md transition-all duration-300 hover:shadow-lg opacity-0 animate-fade-in" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            ...
            {/* Feature Card 3 */}
            <div className="bg-white rounded-xl p-8 shadow-md transition-all duration-300 hover:shadow-lg opacity-0 animate-fade-in" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
              <div className="w-14 h-14 rounded-lg bg-rk-orange-light flex items-center justify-center text-rk-orange mb-6">
            ...
            {/* Feature Card 4 */}
            <div className="bg-white rounded-xl p-8 shadow-md transition-all duration-300 hover:shadow-lg opacity-0 animate-fade-in" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
              <div className="w-14 h-14 rounded-lg bg-rk-blue-light flex items-center justify-center text-rk-blue mb-6">
            ...
            {/* Feature Card 5 */}
            <div className="bg-white rounded-xl p-8 shadow-md transition-all duration-300 hover:shadow-lg opacity-0 animate-fade-in" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
              <div className="w-14 h-14 rounded-lg bg-rk-orange-light flex items-center justify-center text-rk-orange mb-6">
            ...
            {/* Feature Card 6 */}
            <div className="bg-white rounded-xl p-8 shadow-md transition-all duration-300 hover:shadow-lg opacity-0 animate-fade-in" style={{ animationDelay: '0.7s', animationFillMode: 'forwards' }}>
              <div className="w-14 h-14 rounded-lg bg-rk-blue-light flex items-center justify-center text-rk-blue mb-6">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="relative">
              <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300 opacity-0 animate-fade-in" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            ...
            {/* Step 2 */}
            <div className="relative">
              <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300 opacity-0 animate-fade-in" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            ...
            {/* Step 3 */}
            <div className="relative">
              <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300 opacity-0 animate-fade-in" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            ...
            {/* Step 4 */}
            <div className="relative">
              <div className="bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-all duration-300 opacity-0 animate-fade-in" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-rk-blue to-rk-dark text-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Stat 1 */}
            <div className="text-center p-6 opacity-0 animate-fade-in" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
              <div className="text-4xl md:text-5xl font-bold mb-2 text-white">10,000+</div>
              <p className="text-gray-200">Businesses Registered</p>
            </div>

            {/* Stat 2 */}
            <div className="text-center p-6 opacity-0 animate-fade-in" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
              <div className="text-4xl md:text-5xl font-bold mb-2 text-white">98%</div>
              <p className="text-gray-200">Client Satisfaction</p>
            </div>

            {/* Stat 3 */}
            <div className="text-center p-6 opacity-0 animate-fade-in" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
              <div className="text-4xl md:text-5xl font-bold mb-2 text-white">50+</div>
              <p className="text-gray-200">Expert Consultants</p>
            </div>

            {/* Stat 4 */}
            <div className="text-center p-6 opacity-0 animate-fade-in" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-3xl mx-auto divide-y divide-gray-200">
            {/* FAQ Item 1 */}
            <div className="py-5 opacity-0 animate-fade-in" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
            ...
            {/* FAQ Item 2 */}
            <div className="py-5 opacity-0 animate-fade-in" style={{ animationDelay: '0.3s', animationFillMode: 'forwards' }}>
            ...
            {/* FAQ Item 3 */}
            <div className="py-5 opacity-0 animate-fade-in" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            ...
            {/* FAQ Item 4 */}
            <div className="py-5 opacity-0 animate-fade-in" style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
            ...
            {/* FAQ Item 5 */}
            <div className="py-5 opacity-0 animate-fade-in" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
      ...
      <section className="py-16 md:py-24 bg-rk-orange-light">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center opacity-0 animate-fade-in" style={{ animationDelay: '0.1s', animationFillMode: 'forwards' }}>
